module github.com/openshift/router-tests-extension
...
require (
	...
	github.com/openshift/origin v1.6.1-0.20260820072230-dbd1161c1894
...
require (
	...
	github.com/openshift/library-go v0.0.0-20260716164659-7926d144f96a // indirect
